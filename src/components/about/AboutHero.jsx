    ...
    <section className="w-full bg-white min-h-[466px] md:min-h-[648px] flex items-start pt-18 pb-8 md:pt-30 md:pb-4">
      <div className="w-full max-w-[1440px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <Link
            to="/contact"
            className="group mt-6 md:mt-12 w-[100px] h-10 md:w-[189px] md:h-[70px] bg-[#265BA6] rounded-full flex items-center justify-center transition-all duration-300 ease-out border border-transparent hover:bg-white hover:border-[#265BA6] hover:shadow-[0px_4px_20px_0px_#00000040]"
          >
            <span className="text-xs md:text-2xl font-manrope font-medium leading-none text-white group-hover:text-[#265BA6] transition-colors duration-300">
              Contact us
            </span>
          </Link>
        </div>
